...
extern std::array<std::array<uint8_t, 256>, LIGHTSIZE> LightTables;
extern std::array<uint8_t, 256> InfraTables;
extern std::array<uint8_t, 256> StoneTables;
extern std::array<uint8_t, 256> PauseTables;
