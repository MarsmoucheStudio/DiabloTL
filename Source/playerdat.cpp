...
/* HeroClass::Cleric */    { N_("Cleric"),    "warrior",        20,       0,         20,        25,       255,      50,        55,       150,         35,  (2 << 6),  (0 << 6), (2 << 6),                    (1 << 6), static_cast<int>(2.5F * 64),                     (1 << 6), SpellID::HealOther          },
/* HeroClass::Bomoh */     { N_("Bomoh"),      "monk",          15,      25,         15,        30,        45,    200,         85,        130,        10, (2 << 6),  (2 << 6), (1 << 6),                    (1 << 6), static_cast<int>(1.5F * 64),  static_cast<int>(1.5F * 64), SpellID::Confuse,       }
	// clang-format on
};
...
/* HeroClass::Bomoh */     {     112,    112,      130,   128,    98,      98,         114,    114,     114,     160 },
	// clang-format on
};
...
/* HeroClass::Cleric */    {           16,                  9,                  10,                        4,          16,                9,                16,                      9,        16,             11,        20,              8,         16,               8,               16,                     8,          16,               11,         10,              8,              2,          20,            20,              6,             20,                 8,                 14 },
/* HeroClass::Bomoh */     {           12,                  7,                  12,                        7,          16,               12,                16,                     12,        20,             14,        23,             14,         16,              12,               16,                    12,          13,                8,          8,              8,              3,          20,            18,              6,             20,                 8,                 13 },
	// clang-format on
};
